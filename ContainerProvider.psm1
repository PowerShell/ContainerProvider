...
function Find
{
    ...
    try
    {
        ...
        if(IsNanoServer)
        {
            $silverLightDll = [Microsoft.PowerShell.CoreCLR.AssemblyExtensions]::LoadFrom($PSScriptRoot + "\Json.Silverlight4.dll")
            $jsonParser = $silverLightDll.GetTypes() | ? name -match jsonparser
